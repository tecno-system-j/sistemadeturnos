                    ...
                    <div class="col">
                        <div class="page-description d-flex align-items-center">
                            <div class="page-description-content flex-grow-1">
                                <h1>Editar Formulario de Turnos</h1>
                            </div>
                        </div>
                    </div>
                </div>

                <form id="formEditarTurnos">
                    <!-- Campos específicos para la edición de formularios de turnos -->
                    <!-- Aquí se incluirían campos como selección de fecha, ocupación, horario, etc. -->
                    <div class="form-group">
                        <label for="fecha">Fecha</label>
                        <input type="date" id="fecha" name="fecha" class="form-control">
                    </div>
                    <button type="submit" class="btn btn-primary">Actualizar Formulario de Turnos</button>
                </form>
            </div>
        </div>
    </div>
